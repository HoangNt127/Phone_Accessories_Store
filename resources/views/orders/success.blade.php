...
@section('main')
    ...
    <div class="confirmation">
     ...
     <div class="mt-4">
                <a href="{{route('home')}}" class="btn btn-lg custom-button-color">Trở về Trang chủ</a>
    </div>
        ...
        <div style="margin-top: 120px;" id="newsletter" >
			...
			<div class="container">
                ...
                <p style="margin-top: 20px; margin-bottom: 30px;">For any question, we're available at <a href="" class="email-link">nhom13@email.com</a></p>  
